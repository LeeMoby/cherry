...
public class DeviceSafetyController {
    ...
    public String saveDevice(Model model, DeviceSafety deviceSafety, HttpServletRequest request) {
        ...
        int result = deviceSafetyService.addDevcie(deviceSafety, this.getLoginUser(request));
        if (result == 1) {
    ...
    public String deleteDevice(Model model, @RequestParam(value = "deviceIDs[]") Long[] deviceIDs, HttpServletRequest request) {
        ...
        int result = deviceSafetyService.delDevice(deviceIDList, this.getLoginUser(request));
            ...
            if (!file.isEmpty()) {
                ...
                while (sheetIterator.hasNext()) {
                    ...
                    for (int i = 2; i <= lastRowNum; i++) {
                        ...
                        DeviceSafety device = new DeviceSafety();
                        HSSFCell cell;
                        int j = 0;
                        ...
                        try {
                            successRow += deviceSafetyService.addDevcie(device, this.getLoginUser(request));
                        }catch (Exception ex){
                            failureRow++;
                        }
