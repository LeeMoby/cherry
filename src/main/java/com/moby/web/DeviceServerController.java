...
public class DeviceServerController {
    ...
    public String saveDevice(Model model, DeviceServer deviceServer) {
        ...
        int result = deviceServerService.addDevcie(deviceServer, this.getLoginUser());
        if (result == 1) {
    ...
    public String deleteDevice(Model model, @RequestParam(value = "deviceIDs[]") Long[] deviceIDs) {
        ...
        int result = deviceServerService.delDevice(deviceIDList, this.getLoginUser());
    ...
    public void expAllDevice2Excel(HttpServletRequest request,
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment;filename="
                    + java.net.URLEncoder.encode("服务器设备台账.xls", "UTF-8"));
