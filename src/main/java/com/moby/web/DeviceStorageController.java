...
public class DeviceStorageController {
    ...
    public String saveDevice(Model model, DeviceStorage deviceStorage) {
        ...
        int result = deviceStorageService.addDevcie(deviceStorage, this.getLoginUser());
        if (result == 1) {
    ...
    public String deleteDevice(Model model, @RequestParam(value = "deviceIDs[]") Long[] deviceIDs) {
        ...
        int result = deviceStorageService.delDevice(deviceIDList, this.getLoginUser());
    ...
    public void expAllDevice2Excel(HttpServletRequest request,
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment;filename="
                    + java.net.URLEncoder.encode("存储设备台账.xls", "UTF-8"));
